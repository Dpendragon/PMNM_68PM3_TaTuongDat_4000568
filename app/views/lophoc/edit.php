...
<div class="form-card">
  <div class="card-title">
    <i class="bi bi-pencil-square me-2" style="color:#1a56db"></i>Cập nhật lớp học
  </div>
  ...
  <form action="/lophoc/update/<?php echo $lophoc['id']; ?>" method="post">
    <div class="mb-3">
      ...
      <input type="text" id="MaLop" name="MaLop" class="form-control"
        value="<?php echo htmlspecialchars($lophoc['MaLop']); ?>" required>
    </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" id="GhiChu" name="GhiChu" class="form-control"
        value="<?php echo htmlspecialchars($lophoc['GhiChu']); ?>">
    </div>

    <div class="btn-group-form">
      <button type="submit" class="btn btn-warning" style="border-radius:7px; font-size:.875rem; padding:8px 22px;">
